...
if ( typeof define === 'function' && define.amd ) {
	//define( ['jquery', 'datatables'], factory ); //--commenting and adding custom below
//    define(['jquery', 'jquery.dataTables', 'bootstrap.min'], function($) {
//        factory($);
//      });
	define( ['jquery', 'jquery.dataTables', 'bootstrap.min'], factory );
}
else if ( typeof exports === 'object' ) {
    // Node/CommonJS
    factory( require('jquery'), require('jquery.datatables') );
}
